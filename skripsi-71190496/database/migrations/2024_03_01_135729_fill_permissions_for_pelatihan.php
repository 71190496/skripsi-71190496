...
class FillPermissionsForPelatihan extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPelatihan constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.pelatihan.show',
            'admin.pelatihan.edit',
            'admin.pelatihan.delete',
            'admin.pelatihan.bulk-delete',
        ]);
