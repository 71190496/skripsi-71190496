...
class FillPermissionsForDashboardReguler extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDashboardReguler constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dashboard-reguler',
            'admin.dashboard-reguler.index',
            'admin.dashboard-reguler.create',
            'admin.dashboard-reguler.show',
            'admin.dashboard-reguler.edit',
            'admin.dashboard-reguler.delete',
            'admin.dashboard-reguler.bulk-delete',
        ]);
