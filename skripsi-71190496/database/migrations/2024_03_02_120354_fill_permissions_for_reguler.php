...
class FillPermissionsForReguler extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReguler constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.reguler',
            'admin.reguler.index',
            'admin.reguler.create',
            'admin.reguler.show',
            'admin.reguler.edit',
            'admin.reguler.delete',
            'admin.reguler.bulk-delete',
        ]);
