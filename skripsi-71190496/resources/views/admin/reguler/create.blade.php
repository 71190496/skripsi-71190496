...
@section('title', trans('admin.reguler.actions.create'))

@section('body')
    {{-- @dd --}}
        <div class="container-xl">

            <reguler-form :action="'{{ url('admin/regulers') }}'" :fasilitator="{{ $id_fasilitator->toJson() }}" v-cloak
                inline-template>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    @include('brackets/admin-ui::admin.includes.media-uploader', [
                                        'mediaCollection' => app(App\Models\Reguler::class)->getMediaCollection(
                                            'gambar'),
