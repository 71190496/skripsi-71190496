...
<main id="main">
    ...
    <div class="album py-2 px-2  mb-3">
        <div class="container" data-aos="fade-up">
            <form method="post" action="/peserta/reguler">
                @csrf
                ...
                <div class="row row-cols">
                    ...
                    <div class="card py-4 mx-3 mb-3" style="width: 95%">
                        ...
                        <div class="row mb-3">
                            <label class="mb-2" for="informasi_pelatihan">Dimana Anda Mendapat Info Tentang Pelatihan Ini ?</label>
                            <div class="col">
                                <select name="informasi_pelatihan" class="form-select">
                ...
                <a class="btn btn-success" href="/peserta/reguler">Kembali</a>
