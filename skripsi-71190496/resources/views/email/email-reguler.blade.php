    ...
    <![endif]-->
                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                    ...
                    <tr em="block" class="em-structure">
                        <td align="center" style="padding-top: 30px; padding-right: 40px; padding-left: 40px;"
                                ...
                                <tr>
                                    <td width="560" valign="top" class="em-mob-wrap em-mob-width-100perc">
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <img src="https://satunama.org/wp-content/uploads/2023/06/Logo-STC-Satunama-Training-Center-768x408.png"
                                                        width="153" border="0" alt=""
                                                        style="display: block; width: 100%; max-width: 153px;">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
