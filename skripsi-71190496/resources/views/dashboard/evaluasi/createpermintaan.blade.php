...
@section('container')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('dashboard.evaluasipermintaan.save') }}" method="post"
                style="display: none;">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" id="id_permintaan" name="id_permintaan" value="{{ $id_permintaan }}">
            </form>
...
{{-- <div class="col-lg-12 mb-4">
        <form id="form-builder" method="post" action="{{ route('dashboard.evaluasi.storePermintaan') }}">
            @csrf
