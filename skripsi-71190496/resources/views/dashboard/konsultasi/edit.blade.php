...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        <h1 class="h2">Form Edit Pelatihan Konsultasi</h1>
    </div>

    <form method="post" action="/dashboard/konsultasi/{{ $data->id }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_pelatihan') is-invalid @enderror"
                                ...
                                value="{{ old('nama_pelatihan', $data->nama_pelatihan) }}" required autofocus>
