...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        ...
        <div class="d-flex justify-content-end">
            @if ($showButtons)
                <a href="{{ route('dashboard.studidampak.createpermintaan', ['id' => $nilai]) }}" class="btn btn-success "><i
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                @else
                    <table id="studidampak" class="display table dataTable" style="width: 800px; margin: 0 auto;">
                        <thead>
                            <tr>
                                <th>Nama Peserta</th>
