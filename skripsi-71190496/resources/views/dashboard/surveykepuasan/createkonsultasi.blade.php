...
@section('container')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form id="hidden-form" action="{{ route('dashboard.surveykepuasan.storekonsultasi') }}" method="post"
                style="display: none;">
                @csrf
                <input type="hidden" id="form" name="form">
                <input type="hidden" id="id_konsultasi" name="id_konsultasi" value="{{ $id_konsultasi }}">
            </form>
