                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.surveykepuasan.show', $item->id_pelatihan) }}"
                                            class="btn btn-primary px-2"><i style="width:17px" data-feather="eye"></i></a>
                                        <a href="{{ url('/dashboard/surveykepuasan/edit-reguler/' . $item->id_pelatihan) }}" class="btn btn-warning px-2"><i style="width:17px"
                        ...
                        <tbody>
                            @foreach ($data2 as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.surveykepuasan.showpermintaan', $item->id) }}" class="btn btn-primary px-2"><i style="width:17px"
                                                data-feather="eye"></i></a>
                                        <a href="{{ url('/dashboard/surveykepuasan/edit-permintaan/' . $item->id) }}" class="btn btn-warning px-2"><i style="width:17px"
                                                data-feather="edit"></i></a>
                                        {{-- <a href="" class="btn btn-danger px-2"><i style="width:17px"
                                                data-feather="trash"></i></a> --}}
                                    </td>
                        ...
                        <tbody>
                            @foreach ($data3 as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.surveykepuasan.showkonsultasi', $item->id_konsultasi) }}" class="btn btn-primary px-2"><i style="width:17px"
                                                data-feather="eye"></i></a>
                                        <a href="{{ url('/dashboard/surveykepuasan/edit-konsultasi/' . $item->id_konsultasi) }}" class="btn btn-warning px-2"><i style="width:17px"
                                                data-feather="edit"></i></a>
                                    </td>
                                </tr>
                            @endforeach
